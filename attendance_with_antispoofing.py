                ...
                def manage_employee():
                    try:
                        ...
                        def add_employee():
                            ...
                            if eid_var.get() == "" or post_var.get() == "" or fname_var.get() == "" or gender_var.get() ==  "" or contact_var.get() == "" or address_var.get() == "":
                                        ...
                                        if (re.search('^[7-9]\d{9}$', contact_var.get())):
                                            ...
                                            if(re.search(regex, address_var.get())):
                                                ...
                                                if not os.path.exists(input_directory):
                                                    ...
                                                    cur1 = conn.cursor()
                                                    cur1.execute("insert into attendance(eid,department,fname,gender,contact_no,email_address,date_of_join) VALUES (%s,%s,%s,%s,%s,%s,%s)", (
                                                                                                                                                                                eid_var.get(),
                                                                                                                                                                                post_var.get(),
                                                                                                                                                                                fname_var.get(),
                                                                                                                                                                                gender_var.get(),
                    ...
                    ################################################################################### Large Frame
                        ...
                        c1 = Combobox(first, textvariable = search_from, values = ["eid","fname","department"], state = "readonly", width = "25").place(x = 580, y = 109)
    ...
    ######################################### Function to recognize the face
                ...
                def report():
                    ...
                    def search_data():
                        ...
                        conn.close()
                        res_per=pd.Series(np.array(rows)[:,-1]).value_counts(1).round(3)
                        sns.barplot(x=res_per.index,y=res_per)
                        plt.title(str(search_text.get())+" Percentage of attendance")
                ...
                manage_text = 'Attendance Management System'
                ...
                topic = Label(attendance, text = manage , bg = "black" , fg = "orange", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
...
title = Label(face, text = "Face Recognition Attendance System - Admin login" , font = ("times new roman", 30, "bold"), bg = "green", fg = "yellow", bd = 7, relief = GROOVE) 

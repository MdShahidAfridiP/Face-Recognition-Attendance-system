...
def send_mail():
    ...
    server.starttls()
    server.login('shahidzainsz77@gmail.com',pwd)
    for email in absent_staff_emails:
        server.sendmail('shahidzainsz77@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'shahidzainsz77@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('shahidzainsz77@gmail.com',pwd)
        smtp.send_message(msg)



sched = BackgroundScheduler(daemon=True)
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=13, minute=37)
sched.start()
